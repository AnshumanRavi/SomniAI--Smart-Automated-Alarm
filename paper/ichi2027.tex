...
%%
%% Limits: 10 pages including references; minimum 7 pages of main content
%% excluding references; long papers only. Double-blind: the author block is
%% anonymised and the artifact link points at an anonymising proxy. Both of
%% these must be checked against ICHI 2027's own CFP once it is published --
%% the figures here come from the 2026 cycle.
%%
