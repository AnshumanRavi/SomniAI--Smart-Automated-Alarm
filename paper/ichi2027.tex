...
%% >>> REPLACE BEFORE SUBMITTING <<<  The CFP requires repositories revealing
%% authorship to be blinded. Mirror the repo to anonymous.4open.science and put
%% that URL here. Do NOT paste the GitHub link.
\texttt{[anonymised artifact URL]}}
